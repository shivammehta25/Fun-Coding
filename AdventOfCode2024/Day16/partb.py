...
Graph: TypeAlias = dict[tuple[Position, Orientation], list[tuple[Position, Orientation, int, set[Position]]]]
...
BestEdges: TypeAlias = dict[tuple[Position, Orientation], list[tuple[Position, Orientation, set[Position], int]]]
